...
### Changed
- `gregorio-lsp` dependency updated to **v0.7.0**; install instructions updated
  accordingly.

## [0.4.0] - 2026-05-14

### Added
- Keyboard shortcuts for GABC note manipulation (`Ctrl+Alt+Up`, `Ctrl+Alt+Down`,
  `Ctrl+Alt+F`) — all open the code-action menu filtered to `source.gabc` actions.

### Changed
- `gregorio-lsp` dependency updated to **v0.4.0**; install instructions updated
  accordingly.
...
[0.7.0]: https://github.com/AISCGre-BR/zed-gregorio/releases/tag/v0.7.0
[0.4.0]: https://github.com/AISCGre-BR/zed-gregorio/releases/tag/v0.4.0
